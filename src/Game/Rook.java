...
public class Rook implements ChessPiece {
	...
	Image imgWhite = new ImageIcon(getClass().getResource("/Assets/RookBlack.png")).getImage();
	Image imgBlack = new ImageIcon(getClass().getResource("/Assets/RookWhite.png")).getImage();
	int x = 0;
	int y = 0;
	int gridX = 0;
	int gridY = 0;
	...
	public Rook(ChessBoard b, int x, int y, int side) {
		this.b = b;
