...
public class Bishop implements ChessPiece {
	...
	Image imgWhite = new ImageIcon(getClass().getResource("/Assets/BishopBlack.png")).getImage();
	Image imgBlack = new ImageIcon(getClass().getResource("/Assets/BishopWhite.png")).getImage();
	int x = 0;
	int y = 0;
	int gridX = 0;
	int gridY = 0;
	...
	public Bishop(ChessBoard b, int x, int y, int side) {
		this.b = b;
